...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green bold uppercase">category</span>
        </div>
        <div class="actions">
            ...
            <table class="table table-hover">
                ...
                @foreach($data as $key => $value)
                	<tr>
                        ...
                        @endif
                        <td>{{ $value->name }}</td>
                		<td><a href="{{ url('category/').'/'.$value->id."/edit" }}" class="btn btn-primary btn-sm"><i class="icon-pencil"></i>
                		</a>
                        {!! Form::open([
                                    'method'=>'DELETE',
