...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a class="btn btn-primary" href="{{ url('karyawan/create') }}">
                <i class="icon-plus"></i>
            </a>
        </div>
    </div>
            ...
            <table class="table table-hover">
                ...
                @foreach($data as $key => $value)
                	<tr>
                        ...
                        <td>{{ $value->address }}</td>
                        <td>{{ $value->phone }}</td>
                		<td><a href="{{ url('karyawan/').'/'.$value->id."/edit" }}" class="btn btn-primary btn-sm"><i class="icon-pencil"></i>
                		</a>
                        {!! Form::open([
                                    'method'=>'DELETE',
                                    'url' => ['/karyawan', $value->id],
